package dev.dmhdevelopment.modernindustrialization.items.craft_block.Stainless_steel;

import dev.dmhdevelopment.modernindustrialization.utils.ModernIndustrializationCreativeTab;
import net.minecraft.item.Item;

public class Stainless_steelNugget extends Item{
    public Stainless_steelNugget() {
